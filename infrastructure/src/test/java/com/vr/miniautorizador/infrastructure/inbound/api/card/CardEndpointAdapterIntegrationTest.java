...
public class CardEndpointAdapterIntegrationTest {
  ...
  @MockBean
  private GetCardByNumberUseCasePort getCardByNumberUseCasePort;
  @MockBean
  private CreateCardUseCasePort createCardUseCasePort;

  @Test
  public void createCardWhenCardNumberNotExists() throws Throwable {
    ...
    Mockito.doReturn(new Pair<>(card, false))
        .when(this.createCardUseCasePort).execute(CardEndpointMapper.toEntity(cardRequest));

    this.mockMvc.perform(
            MockMvcRequestBuilders.post(CardEndpointAdapterIntegrationTest.PATH)
  ...
  @Test
  public void createCardWhenCardNumberAlreadyExists() throws Throwable {
    final var number = "374245455400126";
    final var password = "12321";
    final var cvv = "901";
    final var expirationDate = "01/25";
    ...
    Mockito.doReturn(new Pair<>(card, true))
        .when(this.createCardUseCasePort).execute(CardEndpointMapper.toEntity(cardRequest));
  ...
  @Test
  public void createCardWhenCardNumberIsNotFilled() throws Throwable {
    final var password = "12321";
    final var cvv = "901";
    final var expirationDate = "01/25";
    final var ownerName = "João";
  ...
  @Test
  public void createCardWhenCardPasswordIsNotFilled() throws Throwable {
    final var number = "374245455400126";
    final var cvv = "901";
    final var expirationDate = "01/25";
    final var ownerName = "João";
  ...
  @Test
  public void getCardBalanceWhenIsFound() throws Throwable {
    ...
    Mockito.doReturn(card).when(this.getCardByNumberUseCasePort).execute(number);

    this.mockMvc.perform(
            MockMvcRequestBuilders.get(CardEndpointAdapterIntegrationTest.PATH + "/" + number)
                .header("Authorization", JwtUtil.generateEncodedJwt(this.jwtSecretKey))
        )
  ...
  @Test
  public void getCardBalanceWhenIsNotFound() throws Throwable {
    final var number = "374245455400126";

    Mockito.doThrow(new NotFoundException("Card Not Found")).when(this.getCardByNumberUseCasePort).execute(number);
